...
const AIStockAdvisor = () => {
  return (
    <div className="glass-card p-6 md:p-8 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-6 md:gap-8 relative overflow-hidden bg-gradient-to-br from-dark-900 to-gold-900/10 border-gold-500/20">
